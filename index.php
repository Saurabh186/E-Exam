...
form input[type=submit]:hover {background-color: #2E86C1;}
...
.fa-camera:hover{color: green;transform: scale(1.3);}
...
<body>
	...
	?>
	          ...
	          <div class="head1"> <h1>Welcome to Online Exam Portal </h1></div>
